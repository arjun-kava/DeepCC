...
opts = [];
opts.dataset_path    = 'D:/Workspace/Research/Dataset/DukeMTMC/';
opts.gurobi_path     = 'D:\Software\Tools\Calculating_Tools\Gurobi801\win64\matlab';
...
identities.extract_images = false;%true;

% CNN model
net = [];
net.train_set = 'data/duke_train.csv';
net.image_root = 'D:/Workspace/Research/Dataset/DukeMTMC/DukeMTMC-reID';
...
breakpoint.threshold = 20;
breakpoint.segment_length = 16;
